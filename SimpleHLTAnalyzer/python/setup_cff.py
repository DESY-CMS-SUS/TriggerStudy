# /dev/CMSSW_7_4_0/HLT/V77 (CMSSW_7_4_0_pre9)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_7_4_0/HLT/V77')
)
...
datasets = cms.PSet( 
  ...
  InitialPD = ( cms.vstring( 'HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV0p41_v1',
    ...
    'HLT_PFHT900_v1',
    'HLT_PFJet140_v1',
    'HLT_PFJet15_NoCaloMatched_v1')+cms.vstring( 'HLT_PFJet200_v1',
    ...
    'HLT_ZeroBias_v1') ),
  InitialPDForHI = cms.vstring( 'HLT_HIL1DoubleMu0_HighQ_v1',
